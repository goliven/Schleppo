...
import com.moco.schleppo.schleppo.dummy.DummyContent;
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.mail_list_content, parent, false);
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(MailDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(MailDetailFragment.ARG_ITEM_ID, holder.mItem.id);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public String toString() {
                return super.toString() + " '" + mdateView.getText() + "'"+ " '" + mContentView.getText() + "'";
            }
        }
    }
}
